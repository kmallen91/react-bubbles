...
- [ ] Explain what a token is used for.
    - Tokens are encrypted lines of code that are given to a user to verify their status on a given webpage

- [ ] What steps can you take in your web apps to keep your data secure?
    - Using tokens to validate users as well as private routes to only allow certain users to specific sections of a site

- [ ] Describe how web servers work.
    - Web servers store, process and deliver web pages to clients on the Internet. Users send requests to a web server and the server delivers the files and forwards them to the clients' computer.
